...
class WC_Big_Post_Shipping_Method extends WC_Shipping_Method
{
	...
	public $API_suburb = 'https://www.bigpost.com.au/api/suburbs';
	public $API_depot = 'https://www.bigpost.com.au/api/depots';
	public $API_requestquote = 'https://www.bigpost.com.au/api/requestquote';
	...
	public function __construct($instance_id = 0)
	{
		...
		$this->method_title = __('Big Post', 'big-post');
		$this->title = __('Big Post', 'big-post');
	...
	public function init_form_fields()
	{
		...
		$pickup_location_type = strtolower(get_option('pickup_location_type'));
		...
		$this->instance_form_fields = array(
			'title' => array(
				...
				'default' => __('Big Post Shipping', 'woocommerce'),
				'desc_tip' => true,
			),
			'username' => array(
				'title' => __('Username', 'big-post'),
				'type' => 'text',
				'description' => __('Enter your username, this could be your email address.', 'big-post'),
				'default' => $this->username
			),
			'api_key' => array(
				'title' => __('API Key', 'big-post'),
				'type' => 'text',
				'description' => __('Get your key from <a target="_blank" href="https://www.bigpost.com.au/Login">https://www.bigpost.com.au/Login</a>', 'big-post'),
				'default' => $this->api_key
			),
			'shop_post_code' => array(
				'title' => __('Shop Origin Post Code', 'big-post'),
				'type' => 'text',
				'description' => __('Enter your Shop postcode.', 'big-post'),
				'default' => '2000',
				'css' => 'width:100px;',
			),
			'pickup_location_type' => array(
				'title' => __('Pickup Location Type', 'big-post'),
				'type' => 'select',
				'description' => __('Origin\'s location type.', 'big-post'),
				'default' => 'Commercial',
				'options' => array(
					'Commercial' => __( $pickup_location_type, 'big-post' ),
					'Residential'    => __( $pickup_location_type, 'big-post' ),
				),
			),
			'default_weight' => array(
				'title' => __('Default Package Weight', 'big-post'),
				'type' => 'text',
				'default' => '0.5',
				'description' => __($weight_unit, 'big-post'),
				'css' => 'width:100px;',
			),
			'default_width' => array(
				'title' => __('Default Package Width', 'big-post'),
				'type' => 'text',
				'default' => '5',
				'description' => __($dimensions_unit, 'big-post'),
				'css' => 'width:100px;',
			),
			'default_height' => array(
				'title' => __('Default Package Height', 'big-post'),
				'type' => 'text',
				'default' => '5',
				'description' => __($dimensions_unit, 'big-post'),
				'css' => 'width:100px;',
			...
			'default_length' => array(
				'title' => __('Default Package Length', 'big-post'),
				'type' => 'text',
				'default' => '10',
				'description' => __($dimensions_unit, 'big-post'),
				'css' => 'width:100px;',
	...
	{
		?>
        <h3><?php _e('Big Post Settings', 'woocommerce'); ?></h3>
		<?php if ($this->debug_mode == 'yes'): ?>
        <div class="updated woocommerce-message">
            <p><?php _e('Big Post debug mode is activated, only administrators can use it.', 'big-post'); ?></p>
        </div>
	<?php endif; ?>
        <div id="poststuff">
                ...
                <div id="postbox-container-1" class="postbox-container">
                    <div id="side-sortables" class="meta-box-sortables ui-sortable">
                        ...
                        <div class="postbox ">
                            ...
                            <h3 class="hndle"><span><i class="dashicons dashicons-update"></i>&nbsp;&nbsp;Upgrade to Pro</span>
                            </h3>
                            <div class="inside">
                                <div class="support-widget">
                                    ...
                                    <a href="https://nicheextensions.com/extensions/woocommerce-bigpost/"
                                       class="button pbweb_button" target="_blank"><span
                                                class="dashicons dashicons-star-filled"></span> Upgrade Now</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="postbox ">
                            <div class="handlediv" title="Click to toggle"><br></div>
                            <h3 class="hndle"><span><i
                                            class="fa fa-question-circle"></i>&nbsp;&nbsp;Plugin Support</span></h3>
                            <div class="inside">
                                <div class="support-widget">
                                    <p>
                                        <img style="width:100%;"
                                             src="https://wpruby.com/wp-content/uploads/2016/03/wpruby_logo_with_ruby_color-300x88.png">
                                        <br/>
                                        Got a Question, Idea, Problem or Praise?</p>
                                    <ul>
                                        <li>» <a target="_blank"
                                                 href="http://auspost.com.au/parcels-mail/size-and-weight-guidelines.html">Weight
                                                and Size Guidlines</a> from Australia Post.
                                        </li>
                                        <li>» <a href="https://wpruby.com/submit-ticket/" target="_blank">Support
                                                Request</a></li>
                                        <li>»
                                            <a href="https://wpruby.com/knowledgebase_category/woocommerce-australia-post-shipping-method-pro/"
                                               target="_blank">Documentation and Common issues</a></li>
                                        <li>» <a href="https://wpruby.com/plugins/" target="_blank">Our Plugins Shop</a>
                                        </li>
                                        <li>» If you like the plugin please leave us a <a target="_blank"
                                                                                          href="https://wordpress.org/support/view/plugin-reviews/australian-post-woocommerce-extension?filter=5#postform">★★★★★</a>
                                            rating.
                                        </li>
                                    </ul>
                        ...
                        <div class="postbox rss-postbox">
                            <div class="handlediv" title="Click to toggle"><br></div>
                            <h3 class="hndle"><span><i class="fa fa-wordpress"></i>&nbsp;&nbsp;PB Web Development Blog</span></h3>
                            <div class="inside">
                                <div class="rss-widget">
									<?php
									wp_widget_rss_output(array(
										'url' => 'https://wpruby.com/feed/',
										'title' => 'PB Web Development Blog',
										'items' => 3,
										'show_summary' => 0,
										'show_author' => 0,
										'show_date' => 1,
		...
		if (!empty($rates)) {
			...
			foreach ($rates as $key => $rate) {
				...
				if (isset($rates[$key]['cost'])) {
					$rates[$key]['cost'] = apply_filters('big_post_shipping_rate', $rates[$key]['cost']);
				}
